...
// Para ello, desean la creación de un programa que al asignar un dni y un monto determine si al empleado en cuestión
// le corresponde o no un aumento. Para ello tiene en cuenta las siguientes condiciones:
...
//Un programador comenzó con el planteo, pero necesita un poco de ayuda para determinar las condiciones para
// cada uno de los casos y qué acciones deberían hacerse... ¿Podrías ayudarlo a terminar?
public class Main {
    public static void main(String[] args) {
        double sueldoBase = 20000; //monto de ejemplo
