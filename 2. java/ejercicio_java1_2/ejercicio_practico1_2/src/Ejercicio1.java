...
en Java pero tuvo varias dudas mientras lo hacía. A partir de esto, nos brindó su código y pidió la ayuda
de un desarrollador experimentado que pueda darle una mano. ¿Podrías verificar su código y realizar las correcciones necesarias?
Pistas:
...
public class Ejercicio1 {
    public static void main(String[] args) {
        ...
        System.out.println("Apellido: " + apellido + " Edad: " + edad + " Boolean: " + logico + " Sueldo: " + sueldo + " Nombre: " + nombre);
    }
}