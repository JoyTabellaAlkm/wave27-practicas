...
*  de tipo int, al igual que para el producto, definir setters, getters, constructor
* que reciba todos los atributos por parámetro y el método toString().
...
public class Perecedero extends Producto {
    ...
    public double calcular(int cantidadDeProductos) {
        return precioFinal(Perecedero.this.getPrecio() * cantidadDeProductos);
    }

    @Override
    public String toString() {
        return "Nombre: " + Perecedero.this.getNombre() + "\nPrecio: " + Perecedero.this.getPrecio() + "\nDías a caducar: " + this.diasPorCaducar;
    }
