...
public class Vehiculo {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getPatente(), vehiculo.getPatente());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getVelocidad(), getAceleracion(), getAnguloDeGiro(), getPatente(), getPeso(), getRuedas());
    }

    @Override
    public String toString() {
        return "entity.Vehiculo{" +
                "velocidad=" + velocidad +
