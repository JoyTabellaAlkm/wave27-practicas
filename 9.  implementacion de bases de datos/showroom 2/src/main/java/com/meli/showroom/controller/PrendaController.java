...
public class PrendaController {
    ...
    @GetMapping("/{code}")
    public ResponseEntity<?> devolverPrenda(@PathVariable String code){
        return new ResponseEntity<>(prendaService.devolverPrenda(code), HttpStatus.OK);
    }

    @PutMapping("/{code}")
    public ResponseEntity<?> actualizarPrenda(@PathVariable String code, @RequestBody PrendaRequestDto prenda){
        return new ResponseEntity<>(prendaService.actualizarPrenda(code, prenda), HttpStatus.OK);
    }

    @DeleteMapping("/{code}")
    public ResponseEntity<?> eliminarPrenda(@PathVariable String code){
