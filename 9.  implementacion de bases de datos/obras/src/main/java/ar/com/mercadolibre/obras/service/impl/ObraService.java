...
public class ObraService implements IObraService {
    ...
    public List<Obra> getAllObras(){
        Page<Obra> page = repository.findAll(PageRequest.of(0, 100));
...
//        return page.getContent();
        return repository.findByNombreSimilar(name);
    }
...
//        return page.getContent();
        return repository.findByAutorMatches(autor);
    }
...
//        return page.getContent();
        return repository.findTop5ByOrderByPaginasDesc();
    }
...
//        return page.getContent();
        return repository.findByAnioPublicacionBefore(year);
    }
    ...
    public List<Obra> saveAll(List<Obra> obras) {
        return repository.saveAll(obras);
    }
}
