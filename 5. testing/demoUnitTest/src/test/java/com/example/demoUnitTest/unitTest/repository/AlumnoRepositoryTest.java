...
public class AlumnoRepositoryTest {
    ...
    @Test
    @DisplayName("Test 2: FindByIdTestNull")
    @Order(2)
    public void findByIdTestNull() {
        //ARRANGE
        //Alumno esperado = null; //Lo que debería devolver el método
        Integer idDeEntrada = 3; // El parametro de entrada para que me devuelva lo esperado

        //ACT
        Alumno obtenido = alumnoRepository.findById(idDeEntrada);

        //ASSERT
        Assertions.assertNull(obtenido, "Pueda que exista el alumno con ese id");
        //Assertions.assertEquals(esperado, obtenido, "Pueda que exista el alumno con ese id");
    }
}
