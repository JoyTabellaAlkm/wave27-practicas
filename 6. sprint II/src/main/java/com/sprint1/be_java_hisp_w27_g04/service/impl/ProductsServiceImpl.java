...
public class ProductsServiceImpl implements IProductsService {
    ...
    public PostListDTO getPostList(int userId, String order) {
        ...
        Set<User> userList = userRepository.findAll().stream().filter(x ->
                followed.contains(x.getId())).collect(Collectors.toSet());
        List<Post> followedPosts = new ArrayList<>();
        savePostWithDateValidate(userList, followedPosts);
    ...
    private void savePostWithDateValidate(Set<User> followed, List<Post> followedPosts) {
